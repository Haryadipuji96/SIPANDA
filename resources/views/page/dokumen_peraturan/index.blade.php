                        ...
                        @forelse ($dokumen_peraturan as $index => $item)
                            <tr class="{{ $index % 2 === 0 ? 'bg-gray-200' : 'bg-gray-100' }}">
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <!-- Hapus -->
                                        <form action="{{ route('dokumen_peraturan.destroy', $item) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                            ...
                            <div x-show="editId === {{ $item->id }}" x-cloak
                                ...
                                <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                                    ...
                                    <form action="{{ route('dokumen_peraturan.update', $item->id) }}" method="POST"
                                        ...
                                        <div class="space-y-2 text-sm">
                                            <input type="text" name="judul" value="{{ $item->judul }}"
                                                placeholder="Judul" required class="w-full border px-2 py-1 rounded">

                                            <input type="text" name="nomor_peraturan"
                                                value="{{ $item->nomor_peraturan }}" placeholder="Nomor Peraturan"
