                        ...
                        @forelse ($dokumen_sk_institusi as $index => $item)
                            <tr class="{{ $index % 2 === 0 ? 'bg-gray-200' : 'bg-gray-100' }}">
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <!-- Hapus -->
                                        <form action="{{ route('dokumen_sk_institusi.destroy', $item) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                            ...
                            <div x-show="editId === {{ $item->id }}" x-cloak
                                ...
                                <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                                    ...
                                    <form action="{{ route('dokumen_sk_institusi.update', $item->id) }}" method="POST"
                                        ...
                                        <input type="text" name="unit_penerbit" value="{{ $item->unit_penerbit }}"
                                            class="w-full border px-2 py-1 mb-2 rounded text-sm">
                                        ...
                                        @if ($item->file_dokumen)
                                            <p class="mb-2 text-start mt-2">
                                                File lama:
                                                <a href="{{ asset('storage/' . $item->file_dokumen) }}" target="_blank"
                                                    class="text-blue-600 underline">Lihat
                                                    File</a>
                                            </p>
                                        @endif
