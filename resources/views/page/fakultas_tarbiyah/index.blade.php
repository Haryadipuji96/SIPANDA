        ...
        <div class="p-6" x-data="{ openTambah: false, editId: null }">
            <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-800 flex items-center gap-2">
                        📘 Dokumen MoU Fakultas Tarbiyah</h1>
                ...
                <form id="bulkDeleteForm" action="{{ route('fakultas_tarbiyah.bulkDelete') }}" method="POST">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="table-wrapper border border-gray-200 rounded-lg">
                        <table class="w-full text-sm border-collapse">
                            ...
                            <tbody>
                                @forelse ($fakultas_tarbiyah as $index => $item)
                                    <tr id="row-{{ $item->id }}"
                                        class="
                                        ...
                                        <td class="border px-4 py-2 text-center">{{ $fakultas_tarbiyah->firstItem() + $index }}</td>
                                        ...
                                        <td class="border px-4 py-2 text-center">
                                            <div class="flex items-center justify-center gap-3">
                                                ...
                                                <!-- Hapus -->
                                                <form action="{{ route('fakultas_tarbiyah.destroy', $item) }}"
                    ...
                    @include('components.pagination', ['data' => $fakultas_tarbiyah])
            </div>
            ...
            <div x-show="openTambah" x-cloak
                ...
                <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                    ...
                    <form action="{{ route('fakultas_tarbiyah.store') }}" method="POST"
