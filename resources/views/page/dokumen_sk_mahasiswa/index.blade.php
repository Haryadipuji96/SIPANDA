    ...
    <div class="p-6" x-data="{ openTambah: false, editId: null }">
                        ...
                        @forelse ($dokumen_sk_mahasiswa as $index => $item)
                            <tr class="{{ $index % 2 === 0 ? 'bg-gray-200' : 'bg-gray-100' }}">
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <!-- Hapus -->
                                        <form action="{{ route('dokumen_sk_mahasiswa.destroy', $item) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                            ...
                            <div x-show="editId === {{ $item->id }}" x-cloak
                                ...
                                <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                                    ...
                                    <form action="{{ route('dokumen_sk_mahasiswa.update', $item->id) }}" method="POST"
        ...
        <div x-show="openTambah" x-cloak
            ...
            <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                ...
                <form action="{{ route('dokumen_sk_mahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
