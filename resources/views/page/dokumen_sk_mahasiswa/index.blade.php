    ...
    <div class="p-6" x-data="{ openTambah: false, editId: null }">
        <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800">📂 Dokumen SK Mahasiswa</h1>
            ...
            <form id="bulkDeleteForm" action="{{ route('dokumen_sk_mahasiswa.bulkDelete') }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="table-wrapper border border-gray-200 rounded-lg">
                    <table class="w-full text-sm border-collapse">
                        ...
                        <tbody>
                            @forelse ($dokumen_sk_mahasiswa as $index => $item)
                                <tr id="row-{{ $item->id }}"
                                    class="
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        {{ $dokumen_sk_mahasiswa->firstItem() + $index }}</td>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex items-center justify-center gap-3">
                                            ...
                                            <!-- Hapus -->
                                            <form action="{{ route('dokumen_sk_mahasiswa.destroy', $item) }}"
                                ...
                                <div x-show="editId === {{ $item->id }}" x-cloak
                                    ...
                                    <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                                        ...
                                        <form action="{{ route('dokumen_sk_mahasiswa.update', $item->id) }}"
                                            ...
                                            <input type="file" name="file_dokumen" class="mb-3 text-sm">
                ...
                @include('components.pagination', ['data' => $dokumen_sk_mahasiswa])
        </div>
        ...
        <div x-show="openTambah" x-cloak
            ...
            <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                ...
                <form action="{{ route('dokumen_sk_mahasiswa.store') }}" method="POST"
