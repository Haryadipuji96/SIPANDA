                    ...
                    <tbody>
                        @forelse ($dokumen_st as $index => $item)
                            <tr class="{{ $index % 2 === 0 ? 'bg-gray-200' : 'bg-gray-100' }}">
                                <td class="border px-4 py-2 text-center">{{ $dokumen_st->firstItem() + $index }}</td>
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <!-- Hapus -->
                                        <form action="{{ route('dokumen_st.destroy', $item) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                ...
                                <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                                    ...
                                    <form action="{{ route('dokumen_st.update', $item->id) }}" method="POST"
                                        ...
                                        <input type="date" name="tanggal_st" value="{{ $item->tanggal_st }}"
                                            class="w-full border px-2 py-1 mb-2 rounded text-sm">
                                        <input type="text" name="pemberi_tugas" value="{{ $item->pemberi_tugas }}"
                                            class="w-full border px-2 py-1 mb-2 rounded text-sm">
                                        <input type="text" name="nama_petugas" value="{{ $item->nama_petugas }}"
                                            class="w-full border px-2 py-1 mb-2 rounded text-sm">
