<x-app-layout>
    ...
    <div class="p-6" x-data="{ openTambah: false, editId: null }">
        <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            <form id="bulkDeleteForm" action="{{ route('fakultas_syariahs.bulkDelete') }}" method="POST">
                @csrf
                @method('DELETE')
    ...
    ">
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        {{ $fakultas_syariahs->firstItem() + $index }}
                                    </td>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex items-center justify-center gap-3">
                                            ...
                                            <!-- Hapus -->
                                            <form action="{{ route('fakultas_syariahs.destroy', $item) }}"
                ...
                <div x-show="openTambah" x-cloak
                    ...
                    <div class="bg-white p-6 rounded-lg w-96">
                        ...
                        <form action="{{ route('fakultas_syariahs.store') }}" method="POST"
