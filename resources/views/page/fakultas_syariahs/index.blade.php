    ...
    <div class="p-6" x-data="{ openTambah: false, editId: null }">
        <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-xl sm:text-2xl font-bold text-gray-800 flex items-center gap-2">📂 Dokumen Fakultas
                    Syariah</h1>
                ...
                <table class="w-full text-sm border-collapse">
                    ...
                    <tbody>
                        @forelse ($fakultas_syariahs as $index => $item)
                            <tr
                                class="{{ $index % 2 === 0 ? 'bg-gray-200' : 'bg-gray-100' }} hover:bg-gray-100 transition">
                                <td class="border px-4 py-2 text-center">{{ $fakultas_syariahs->firstItem() + $index }}
                                </td>
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <!-- Hapus -->
                                        <form action="{{ route('fakultas_syariahs.destroy', $item) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                            ...
                            <div x-show="editId === {{ $item->id }}" x-cloak
                                ...
                                <div class="bg-white p-6 rounded-lg w-96">
                                    ...
                                    <form action="{{ route('fakultas_syariahs.update', $item->id) }}" method="POST"
            ...
            @include('components.pagination', ['data' => $fakultas_syariahs])
