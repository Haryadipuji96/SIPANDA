<x-app-layout>
    ...
    <div class="p-4 md:p-6" x-data="{ openTambah: false, editId: null }">
        <div class="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-4 md:p-6">
            ...
            <form id="bulkDeleteForm" action="{{ route('dokumen_iait.bulkDelete') }}" method="POST">
                @csrf
                @method('DELETE')
                        ...
                        <tbody>
                            @forelse ($dokumen_iait as $index => $item)
                                <tr id="row-{{ $item->id }}"
                                    ...
                                    <td class="border px-4 py-2 text-center">{{ $dokumen_iait->firstItem() + $index }}
                                    </td>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex items-center justify-center gap-3">
                                            ...
                                            <!-- Hapus -->
                                            <form action="{{ route('dokumen_iait.destroy', $item) }}" method="POST"
                                                class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button"
