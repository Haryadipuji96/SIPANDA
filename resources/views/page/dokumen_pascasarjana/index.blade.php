                ...
                <table class="min-w-full table-auto text-sm border-collapse">
                    ...
                    <tbody>
                        @forelse ($dokumen_pascasarjana as $index => $item)
                            <tr class="{{ $index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-50' }}">
                            ...
                            <div x-show="editId === {{ $item->id }}" x-cloak
                                ...
                                <div
                                    ...
                                    <!-- Form -->
                                    <form action="{{ route('dokumen_pascasarjana.update', $item->id) }}" method="POST"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 px-6">
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-1">Lembaga
                                                        Mitra</label>
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="file" name="file_dokumen"
                                                        ...
                                                        class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent">
                                                    <p class="text-xs text-gray-500 mt-1">Format: PDF, DOC, DOCX, JPG,
                                                        PNG (Maks. 5MB)</p>
