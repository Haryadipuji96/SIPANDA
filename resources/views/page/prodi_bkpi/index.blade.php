        ...
        <div class="p-6" x-data="{ openTambah: false, editId: null }">
            <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">📘 Dokumen MoU Prodi BKPI</h1>
                                    ...
                                    <td class="border px-4 py-2 text-center space-x-2 flex justify-center">
                                        ...
                                        <div x-show="editId === {{ $item->id }}" x-cloak
                                            ...
                                            <div class="bg-white p-6 rounded-lg w-96 shadow-lg">
                                                ...
                                                <form action="{{ route('prodi_bkpi.update', $item->id) }}"
                                        ...
                                        <!-- Tombol Hapus -->
                                        <form action="{{ route('prodi_bkpi.destroy', $item->id) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
