<x-app-layout>
    ...
    <div class="p-4 sm:p-6" x-data="{ openTambah: false, editId: null }">
        <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-4 sm:p-6">
            ...
            <form id="bulkDeleteForm" action="{{ route('dokumen-ekonomi.bulkDelete') }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200">
                    <table class="min-w-full text-sm border-collapse">
                        ...
                        <tbody>
                                ...
                                <tr id="row-{{ $item->id }}"
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        ...
                                        <div class="flex items-center justify-center gap-3">
                                            ...
                                            <!-- Hapus -->
                                            <form action="{{ route('dokumen-ekonomi.destroy', $item) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-3 bg-gray-50 text-gray-500">Belum ada
                                        data</td>
                                </tr>
                            @endforelse
                        </tbody>
